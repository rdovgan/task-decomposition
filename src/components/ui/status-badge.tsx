...
const statusConfig: Record<string, { label: string; className: string }> = {
  ...
  // Epic statuses
  BACKLOG: { label: 'Backlog', className: 'bg-gray-100 text-gray-800 dark:bg-gray-800 dark:text-gray-400' },
  IN_PROGRESS: { label: 'In Progress', className: 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400' },
  IN_REVIEW: { label: 'In Review', className: 'bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-400' },
  DONE: { label: 'Done', className: 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' },
  CANCELLED: { label: 'Cancelled', className: 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400' },

  // Task statuses
  TODO: { label: 'To Do', className: 'bg-gray-100 text-gray-800 dark:bg-gray-800 dark:text-gray-400' },
