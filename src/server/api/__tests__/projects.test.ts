...
describe("Projects API", () => {
  ...
  describe("GET /api/projects/:id", () => {
    it("returns a single project", async () => {
      ...
      const response = await request(app).get("/api/projects/123").expect(200);
  ...
  describe("PATCH /api/projects/:id", () => {
    ...
    it("returns 404 when project to update not found", async () => {
      prisma.project.update.mockRejectedValue(new Error("Record to update not found"));
  ...
  describe("DELETE /api/projects/:id", () => {
    it("deletes a project", async () => {
      ...
      const response = await request(app).delete("/api/projects/123").expect(200);
    ...
    it("returns 404 when project to delete not found", async () => {
      prisma.project.delete.mockRejectedValue(new Error("Record to delete not found"));

      const response = await request(app).delete("/api/projects/999").expect(500);
